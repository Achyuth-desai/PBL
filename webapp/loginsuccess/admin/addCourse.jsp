...
<%
	...
	<div class="v126_30">
		...
		<input id="cid" type="text" name="courseid" required="on"><br>
		<label>Course Name : </label> 
		<input id="cname" type="text" name="coursename" required="on"><br>
		<label>Credits :</label>
		...
		<label>&nbsp;</label>
		<input id="addcou" type="submit" value="Add Course">
	</form>
		<!-- </div>
