...
<%
	...
	<div class="v126_30">
		...
		<div id="form">
			<form action="updateFacultyDetails" method="post">
		...
		<input id="id" type="text" name="facultyid" required="on" value=${faculty.facultyid} readonly="readonly"><br>
		<label>First Name : </label> 
		<input id="fname" type="text" name="firstname" required="on" value=${faculty.firstname}><br>
		<label>Last Name : </label>	
		<input id="lname" type="text" name="lastname" required="on" value=${faculty.lastname}><br>
		...
		<label>&nbsp;</label>
		<input id="addfac" type="submit" value="Update Faculty">
	</form>
		</div>
